...
\myterm{类星体}{quasi-stellar objects, QSOs}
\myterm[1]{解析解}{analytic solution}
\myterm{形式体系}{formalism}
\myterm[1]{非对角线的}{off-diagonal}
\myterm{规范不变的}{gauge-invariant}
\myterm[1]{各向异性的}{anisotropic}
\myterm{共动规范}{comoving-gauge}
\myterm{设定}{set-up}
\myterm{编码}{encode}
\myterm{解码}{decode}
\myterm{原初黑洞}{primordial black holes, PBHs}
\myterm[1]{重加热}{reheating}
\myterm{量子色动力学转变}{Quantum Chromodynamics transition, QCD transition}
\myterm[1]{重电离}{reionization}
\myterm{强能量条件}{strong energy condition, SEC}
...
参见表 \ref{表格引用测试}，参见子表 \ref{表格引用测试a}，见表 \ref{表格引用测试b}。
...
图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：图片双语标题：见图 \ref{dulang_fig}
\begin{figure}[h!]
	\centering
	\begin{subfigure}{0.4\linewidth}
		\centering
		\includegraphics[scale=.5]{example-image-c}
		\bicaption{说明}{explanation}
	\end{subfigure}
	\hfil
	\begin{subfigure}{0.4\linewidth}
		\centering
		\includegraphics[scale=.5]{example-image}
		\bicaption{演示}{demonstration}
	\end{subfigure}
	
	\bicaption{超长长长长长长长长长长长长\\ 长长长长长长长长长长长长长长长长长长长长长长长长\\ 长长长长长长长长长长长长长长长长长长长长标题，图片引用测试}{Super long long long long long long long long long long \\ long long long long long long long long long long long long long \\ long long long long long long title, image citation test. }
	\label{dulang_fig}
\end{figure}

表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题：表格双语标题： 见表 \ref{dulang_tale}
\begin{table}[h!]
	\centering
	\bicaption{表格引用测试}{Table reference test.} \label{dulang_tale}
	\begin{subtable}{0.4\linewidth}
		\centering
		\begin{tblr}{
				row{odd} = {bg=azure8},
